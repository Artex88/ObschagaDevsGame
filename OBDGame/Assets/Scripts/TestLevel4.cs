...
public class TestLevel4 : MonoBehaviour
{
    public Slot[] slots;
    public Item pc1;
    public Item pc2;
    ...
    public bool Test()
    {
        ...
        if (slots[0].transform.GetChild(0).IsChildOf(pc1.transform) ||
            ...
            slots[0].transform.GetChild(0).IsChildOf(pc5.transform)) { }
        else { return false; }
        ...
        if (slots[1].transform.GetChild(0).IsChildOf(pc1.transform) ||
            ...
            slots[1].transform.GetChild(0).IsChildOf(pc5.transform)) { }
        else { return false; }
        ...
        if (slots[2].transform.GetChild(0).IsChildOf(pc1.transform) ||
            ...
            slots[2].transform.GetChild(0).IsChildOf(pc5.transform)) { }
        else { return false; }
        ...
        if (slots[3].transform.GetChild(0).IsChildOf(pc1.transform) ||
            ...
            slots[3].transform.GetChild(0).IsChildOf(pc5.transform)) { }
        else { return false; }
        ...
        if (slots[4].transform.GetChild(0).IsChildOf(pc1.transform) ||
            ...
            slots[4].transform.GetChild(0).IsChildOf(pc4.transform) ||
            slots[4].transform.GetChild(0).IsChildOf(pc5.transform)) { }
        else { return false; }


        if (!slots[5].transform.GetChild(0).IsChildOf(line1.transform)) return false;

        if (slots[6].transform.GetChild(0).IsChildOf(line2.transform) || slots[6].transform.GetChild(0).IsChildOf(line3.transform)) { } else { return false; } 

        if (!slots[7].transform.GetChild(0).IsChildOf(line4.transform)) return false;

        if (slots[8].transform.GetChild(0).IsChildOf(line2.transform) || slots[8].transform.GetChild(0).IsChildOf(line3.transform)) { } else { return false; }

        if (!slots[9].transform.GetChild(0).IsChildOf(line5.transform)) return false;
        ...
        string[] ipPc5 = ipPc5T.text.Trim().Split('.');
        ...
        if (ip[0] != ipPc1[0] || ip[1] != ipPc1[1] || ip[2] != ipPc1[2] || ip[3] != ipPc1[3] ||
            ...
            ip[0] != ipPc5[0] || ip[1] != ipPc5[1] || ip[2] != ipPc5[2] || ip[3] == ipPc5[3] || int.Parse(ipPc5[3]) > 255 || int.Parse(ipPc5[3]) < 0 ||
            ipPc1[3] == ipPc2[3] || ipPc1[3] == ipPc3[3] || ipPc3[3] == ipPc2[3] || ipPc4[3] == ipPc5[3] || ipPc4[3] == ipPc1[3] || ipPc4[3] == ipPc2[3] || ipPc4[3] == ipPc3[3] ||
            ipPc1[3] == ipPc5[3] || ipPc2[3] == ipPc5[3] || ipPc3[3] == ipPc5[3])
        {
