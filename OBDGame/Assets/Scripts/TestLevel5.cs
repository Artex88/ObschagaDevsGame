...
public class TestLevel5 : MonoBehaviour
{
    public Slot[] slots;
    public Item pc1;
    public Item pc2;
    ...
    public bool Test()
    {
        ...
        if ((slots[4].transform.GetChild(0).IsChildOf(line1.transform) || slots[4].transform.GetChild(0).IsChildOf(line2.transform))) 
        { 
            if (slots[5].transform.GetChild(0).IsChildOf(line4.transform) || slots[5].transform.GetChild(0).IsChildOf(line5.transform))
            {
                return false;
            }

            if (slots[6].transform.GetChild(0).IsChildOf(line4.transform) || slots[6].transform.GetChild(0).IsChildOf(line5.transform)){}
            else
            {
                return false;
            }

            if (slots[7].transform.GetChild(0).IsChildOf(line4.transform) || slots[7].transform.GetChild(0).IsChildOf(line5.transform)) { }
            else
            {
                return false;
            }

            if (!slots[8].transform.GetChild(0).IsChildOf(line6.transform))
            {
                return false;
            }
            if (!slots[9].transform.GetChild(0).IsChildOf(line3.transform))
            {
                return false;
            }
        ...
        {
            if ((slots[4].transform.GetChild(0).IsChildOf(line4.transform) || slots[4].transform.GetChild(0).IsChildOf(line5.transform)))
            {
                if (slots[5].transform.GetChild(0).IsChildOf(line1.transform) || slots[5].transform.GetChild(0).IsChildOf(line2.transform))
                {
                    return false;
                }

                if (slots[6].transform.GetChild(0).IsChildOf(line1.transform) || slots[6].transform.GetChild(0).IsChildOf(line2.transform)) { }
                else
                {
                    return false;
                }
                ...
                if (!slots[8].transform.GetChild(0).IsChildOf(line3.transform))
                {
                    return false;
                }
                if (!slots[9].transform.GetChild(0).IsChildOf(line6.transform))
                {
                    return false;
                }
